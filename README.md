...
|------|------------|--------------|
| **Python** | A programming language | Lets developers write instructions that a computer can run — used to build tools, automate tasks, analyse data, and more |
| **Git** | A version control system | Tracks every change ever made to a project's code, so the team can see the full history, undo mistakes, and work on the same files without overwriting each other |
